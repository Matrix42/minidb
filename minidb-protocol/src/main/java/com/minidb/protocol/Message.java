...
public interface Message {
    ...
    record ArrowContinuation(long requestId, long cursorId, boolean lastBatch, ByteBuf data)
            implements Message {}
    ...
    record TablesRequest(
            long requestId, String schemaPattern, String tableNamePattern, String[] types)
            implements Message {}

    record ColumnsRequest(
            long requestId, String schemaPattern, String tableNamePattern, String columnNamePattern)
            implements Message {}
}
