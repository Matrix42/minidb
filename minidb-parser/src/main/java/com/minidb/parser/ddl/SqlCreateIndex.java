 ...
 *
 * <p>Extends {@link SqlCreate} so the FMPP template's
 * {@code createStatementParserMethods} (which returns {@code SqlCreate}) can
 * dispatch to this node.  {@link SqlCreate} extends {@link org.apache.calcite.sql.SqlDdl},
