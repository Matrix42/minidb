...
public final class ScalarKernels {
    ...
    @FunctionalInterface public interface ShortUnary { short apply(short v); }
    @FunctionalInterface public interface FloatUnary { float apply(float v); }
    @FunctionalInterface public interface DecimalUnary { BigDecimal apply(BigDecimal v); }
    ...
    @FunctionalInterface public interface ShortBinary { short apply(short a, short b); }
    @FunctionalInterface public interface FloatBinary { float apply(float a, float b); }
    @FunctionalInterface public interface DecimalBinary { BigDecimal apply(BigDecimal a, BigDecimal b); }
    ...
    @FunctionalInterface public interface ShortCompare { int apply(short a, short b); }
    @FunctionalInterface public interface FloatCompare { int apply(float a, float b); }
    @FunctionalInterface public interface DecimalCompare { int apply(BigDecimal a, BigDecimal b); }
    @FunctionalInterface public interface BytesCompare { int apply(byte[] a, byte[] b); }
}
