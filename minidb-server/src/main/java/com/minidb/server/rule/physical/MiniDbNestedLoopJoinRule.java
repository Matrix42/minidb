...
/**
 * Nested-loop join handles any condition (equi or not), so this rule has no
 * equi pre-check; it is the fallback when the Hash/SortMerge rules decline.
 */
public final class MiniDbNestedLoopJoinRule extends ConverterRule {

    public MiniDbNestedLoopJoinRule() {
        this(Config.INSTANCE
                .withConversion(LogicalJoin.class, Convention.NONE, MiniDbConvention.INSTANCE, "MiniDbNestedLoopJoinRule")
    ...
    public RelNode convert(RelNode rel) {
        ...
        return new MiniDbNestedLoopJoin(join.getCluster(), traits,
