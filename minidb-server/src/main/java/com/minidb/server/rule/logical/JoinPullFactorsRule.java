...
/**
 * 与 {@link FilterPullFactorsRule} 同款,但作用于 Join 条件:FilterIntoJoinRule 把
 * 含 OR 的 Filter 下推进 Join 后,公共等值项仍埋在 Join 条件的 OR 里,导致
 * {@code JoinInfo.of} 抽不出等值键、只能走 NestedLoopJoin。因子化后等值键回到顶层
...
public final class JoinPullFactorsRule extends RelOptRule {
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        RelNode newJoin = join.copy(join.getTraitSet(), factored,
