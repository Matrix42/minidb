-- MiniDB TPC-DS 脚本:先 ANALYZE 所有表,再跑解析后的查询
-- 由 GenSql 生成,查询来自 DSGen query_templates 经 TpcdsTemplateParser 解析适配

-- ===== ANALYZE(建统计,供 CBO join 基数估算)=====
ANALYZE call_center;
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '41248','88884','39970','77525','41505','66918',
                          '65519','18093','37182','47502','55276',
                          '42292','64476','28032','28456','26170',
                          '78743','52209','11400','87863','17226',
                          '12913','51243','75241','86030','87458',
                          '47387','28246','76730','40756','32430',
                          '11085','38217','17727','35212','68093',
                          '60713','11164','32379','48065','59823',
                          '72737','93975','40534','62807','76935',
                          '70157','78443','37193','34440','45558',
                          '14756','47160','84410','45713','54059',
                          '58261','16003','95897','42819','27552',
                          '16601','59094','40794','72798','69719',
                          '93775','69499','62390','27501','11453',
                          '20429','47573','83733','10986','52460',
                          '80625','22093','38200','92594','71403',
                          '77142','77807','62593','84109','16744',
                          '40398','24479','73747','37696','89923',
                          '93295','66759','84823','18229','93976',
                          '55476','73328','79870','51140','87532',
                          '90029','34983','21911','12709','33246',
                          '45275','12522','72846','78104','37597',
                          '34451','54031','72670','48806','77795',
                          '60606','75679','10246','31228','44958',
                          '15323','32652','32332','52322','77923',
                          '16433','59402','22352','98172','46238',
                          '27932','76672','99168','40525','83442',
                          '66627','76433','71373','15027','76721',
                          '22923','59904','94803','96778','87093',
                          '26447','45741','41630','58035','45021',
                          '50755','25481','30299','72600','11151',
                          '12342','49441','72284','34996','82740',
                          '80610','18065','18070','39030','45529',
                          '19029','56291','96324','34434','88741',
                          '41308','17006','41881','50212','16996',
                          '60929','95342','74046','73589','18210',
                          '62999','46774','43785','14536','81745',
                          '88492','90331','43398','32293','55866',
                          '77978','81766','29379','96189','89943',
                          '79793','53374','56209','16668','40378',
                          '37188','31269','72377','80122','25991',
                          '44654','66780','70150','53693','40488',
                          '11948','62894','72305','94359','43731',
                          '27183','60323','81675','44181','91511',
                          '27843','42673','41553','93416','49493',
                          '35174','35987','76405','56417','40118',
                          '83347','86266','53659','51587','28510',
                          '86553','65290','62386','91486','16431',
                          '24230','15088','82921','65141','69891',
                          '75730','32675','24193','50245','85881',
                          '29425','12253','98095','93459','88459',
                          '74815','27131','71358','86509','36760',
                          '47816','91064','18347','79065','22107',
                          '10099','56206','81294','96340','80788',
                          '34031','36510','70159','88186','27806',
                          '27643','75842','91067','90399','50452',
                          '44137','36410','32866','59819','25788',
                          '56725','94590','17440','91018','88619',
                          '87882','54507','98037','85963','21575',
                          '53241','23993','55047','50189','77134',
                          '76666','85960','35569','25913','68633',
                          '81866','20352','32565','19938','20984',
                          '73674','39243','50694','43955','61613',
                          '41605','16800','25387','45005','50494',
                          '27509','98688','41518','52629','26781',
                          '65986','80302','91248','43593','54741',
                          '69137','45036','39696','33857','30953',
                          '20771','85386','39109','47794','36007',
                          '62056','90011','70488','18842','58813',
                          '35959','70518','98224','18557','63241',
                          '20956','62860','69329','22706','97212',
                          '76007','83732','13923','62577','71680',
                          '60302','49856','71164','72765','21226',
                          '46596','58380','60895','16741','46718',
                          '61081','96852','71366','61529','30894',
                          '42165','53588','21802','52992','57952',
                          '29945','84802','91887','10992','28145',
                          '16515','10921','69432','87950','46848',
                          '31029','55055','72876','58717','84546',
                          '77092','90860','56693','30077')
     intersect
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 11249
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 148885
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 169971
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 87526
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 21506
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Fayette County','Fayette County','Fayette County','Fayette County','Fayette County') and
...
where
    d_date between '2001-2-01' and 
           (cast('2001-2-01' as date) )
and cs1.cs_ship_date_sk = d_date_sk
and cs1.cs_ship_addr_sk = ca_address_sk
and ca_state = 'CA'
and cs1.cs_call_center_sk = cc_call_center_sk
and cc_county in ('5','5','5','5',
                  '5'
)
and exists (select *
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,1,9,7,2,6) and
       d_year = 1998 and
       ca_state in ('CA','CA','CA'
                   ,'CA','CA','CA','CA')
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2000-01-01' as date))
...
from (select avg(ss_list_price) B1_LP
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 152 and 152+10
          or ss_coupon_amt between 8490 and 8490+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 54 and 54+10
          or ss_coupon_amt between 12121 and 12121+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 184 and 184+10
          or ss_coupon_amt between 9412 and 9412+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 54 and 54+10
          or ss_coupon_amt between 1668 and 1668+1000
...
and d_date between '2000-01-01' and 
...
select  i_item_id
 ...
 and d_date between cast('2000-01-01' as date) and (cast('2000-01-01' as date) )
 and i_manufact_id in (780,683,731,677)
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 839 and 839+40 
   and (select count(*) as item_cnt
        ...
        (i_color = '1' or i_color = '1') and 
        (i_units = '1' or i_units = '1') and
        (i_size = '1' or i_size = '1')
        ) or
        (i_category = 'Women' and
        (i_color = '1' or i_color = '1') and
        (i_units = '1' or i_units = '1') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Midway','Midway','Midway','Midway','Midway') 
...
select  
  ...
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk > 30) and 
                 (sr_returned_date_sk - ss_sold_date_sk <= 60) then 1 else 0 end )  as "31" 
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk > 60) and 
                 (sr_returned_date_sk - ss_sold_date_sk <= 90) then 1 else 0 end)  as "61" 
  ,sum(case when (sr_returned_date_sk - ss_sold_date_sk > 90) and
                 (sr_returned_date_sk - ss_sold_date_sk <= 120) then 1 else 0 end)  as "91" 
...
select  
  ...
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk > 30) and 
                 (ws_ship_date_sk - ws_sold_date_sk <= 60) then 1 else 0 end )  as "31" 
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk > 60) and 
                 (ws_ship_date_sk - ws_sold_date_sk <= 90) then 1 else 0 end)  as "61" 
  ,sum(case when (ws_ship_date_sk - ws_sold_date_sk > 90) and
                 (ws_ship_date_sk - ws_sold_date_sk <= 120) then 1 else 0 end)  as "91" 
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 10078 and 10078+28800 
 	and sm_carrier in ('1','1')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 0 or
             household_demographics.hd_vehicle_count= -1)
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Midway','Midway')
...
WITH all_sales AS (
 ...
 FROM (SELECT d_year
       ...
       WHERE i_category='1') sales_detail
...
select  i_item_id
 ...
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-01-01' as date) and (cast('2000-01-01' as date) )
 and i_manufact_id in (249,885,971,526)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-01-01','2000-01-01','2000-01-01')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Midway'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  8810
   and ib_upper_bound   <=  8810 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('1','1','1') and
          i_class in ('1','1','1')
         )
      or (i_category in ('1','1','1') and
          i_class in ('1','1','1') 
        ))
...
select  
  ...
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk > 30) and 
                 (cs_ship_date_sk - cs_sold_date_sk <= 60) then 1 else 0 end )  as "31" 
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk > 60) and 
                 (cs_ship_date_sk - cs_sold_date_sk <= 90) then 1 else 0 end)  as "61" 
  ,sum(case when (cs_ship_date_sk - cs_sold_date_sk > 90) and
                 (cs_ship_date_sk - cs_sold_date_sk <= 120) then 1 else 0 end)  as "91" 
